...
public class SuperficiePlana {
	...
	public static void main(String[] args) {
	   ...
	   // Crear instancias de Círculo
    Circulo circulo1 = new Circulo("Círculo Nro. 1", 5.0, new Punto(0, 0));
    Circulo circulo2 = new Circulo("Círculo Nro. 2", 3.0, new Punto(4, 4));

    // Agregar los círculos a la lista
    figurasGeometricas.add(circulo1);
    figurasGeometricas.add(circulo2);

    // Crear instancias de Rectángulo
    Punto v1 = new Punto(0, 0);
    Punto v2 = new Punto(0, 2);
    Punto v3 = new Punto(3, 2);
    Punto v4 = new Punto(3, 0);

    Rectangulo rectangulo1 = new Rectangulo("Rectángulo Nro. 1", v1, v2, v3, v4);

    // Agregar los rectángulos a la lista
    figurasGeometricas.add(rectangulo1);

    // Instanciamos un objeto llamado superficiePlana con la lista de figuras geométricas.
    SuperficiePlana superficiePlana = new SuperficiePlana(figurasGeometricas);

    System.out.println(superficiePlana.toString());
    System.out.println(
            "La suma total de las áreas de las figuras geométricas es: " + superficiePlana.calcularTotalArea());
}
}
/* package laboratorioPoo1;
import java.util.ArrayList;
